 ...
 */
@Entity
@Table(name = "ERR_DOC_TICKET")
@NamedQueries({
    @NamedQuery(name = "ErrDocTicket.findAll", query = "SELECT e FROM ErrDocTicket e")})
public class ErrDocTicket implements Serializable {
    ...
    @ManyToOne
    private DocTicket pos;

    public ErrDocTicket() {
    }

    public ErrDocTicket(Integer code) {
        this.code = code;
    }
    ...
    public DocTicket getPos() {
        return pos;
    }

    public void setPos(DocTicket pos) {
        this.pos = pos;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ErrDocTicket)) {
            return false;
        }
        ErrDocTicket other = (ErrDocTicket) object;
    ...
    public String toString() {
        return "org.tyaa.teplosetejb.entity.ErrDocTicket[ code=" + code + " ]";
    }
