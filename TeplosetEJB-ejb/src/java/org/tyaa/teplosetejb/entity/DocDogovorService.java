 ...
 */
@Entity
@Table(name = "DOC_DOGOVOR_SERVICE")
@NamedQueries({
    @NamedQuery(name = "DocDogovorService.findAll", query = "SELECT d FROM DocDogovorService d")})
public class DocDogovorService implements Serializable {
    ...
    @Column(name = "CHANGE_ACCOUNT_STATE")
    private Integer changeAccountState;
    ...
    public DocDogovorService() {
    }

    public DocDogovorService(Integer code) {
        this.code = code;
    }

    public DocDogovorService(Integer code, int state) {
        this.code = code;
        this.state = state;
    }
    ...
    public Integer getChangeAccountState() {
        return changeAccountState;
    }

    public void setChangeAccountState(Integer changeAccountState) {
        this.changeAccountState = changeAccountState;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof DocDogovorService)) {
            return false;
        }
        DocDogovorService other = (DocDogovorService) object;
    ...
    public String toString() {
        return "org.tyaa.teplosetejb.entity.DocDogovorService[ code=" + code + " ]";
    }
