 ...
 */
@Entity
@Table(name = "H_ACCOUNT_DOG_SERVICE")
@NamedQueries({
    @NamedQuery(name = "HAccountDogService.findAll", query = "SELECT h FROM HAccountDogService h")})
public class HAccountDogService implements Serializable {
    ...
    @Basic(optional = false)
    @NotNull
    @Column(name = "ACCOUNT_DOG_SERVICE_CODE")
    private int accountDogServiceCode;
    @Basic(optional = false)
    @NotNull
    ...
    public HAccountDogService() {
    }

    public HAccountDogService(Integer code) {
        this.code = code;
    }

    public HAccountDogService(Integer code, int accountDogServiceCode, int saldokind, long accountcode, int procdate) {
        this.code = code;
        this.accountDogServiceCode = accountDogServiceCode;
    ...
    public int getAccountDogServiceCode() {
        return accountDogServiceCode;
    }

    public void setAccountDogServiceCode(int accountDogServiceCode) {
        this.accountDogServiceCode = accountDogServiceCode;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof HAccountDogService)) {
            return false;
        }
        HAccountDogService other = (HAccountDogService) object;
    ...
    public String toString() {
        return "org.tyaa.teplosetejb.entity.HAccountDogService[ code=" + code + " ]";
    }
