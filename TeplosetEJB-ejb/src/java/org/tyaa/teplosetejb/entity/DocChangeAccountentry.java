 ...
 */
@Entity
@Table(name = "DOC_CHANGE_ACCOUNTENTRY")
@NamedQueries({
    @NamedQuery(name = "DocChangeAccountentry.findAll", query = "SELECT d FROM DocChangeAccountentry d")})
public class DocChangeAccountentry implements Serializable {
    ...
    private Integer accountServiceCode;
    private Double koeff2;
    @Column(name = "DISCOUNT_PERCENT2")
    ...
    public DocChangeAccountentry() {
    }

    public DocChangeAccountentry(Integer code) {
        this.code = code;
    }

    public DocChangeAccountentry(Integer code, long pos, int state) {
        this.code = code;
        this.pos = pos;
        this.state = state;
    }
    ...
    public Integer getAccountServiceCode() {
        return accountServiceCode;
    }

    public void setAccountServiceCode(Integer accountServiceCode) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof DocChangeAccountentry)) {
            return false;
        }
        DocChangeAccountentry other = (DocChangeAccountentry) object;
    ...
    public String toString() {
        return "org.tyaa.teplosetejb.entity.DocChangeAccountentry[ code=" + code + " ]";
    }
