 ...
 */
@Entity
@Table(name = "SPR_PARTNER")
@NamedQueries({
    @NamedQuery(name = "SprPartner.findAll", query = "SELECT s FROM SprPartner s")})
public class SprPartner implements Serializable {
    ...
    public SprPartner(Integer code) {
        this.code = code;
    }

    public SprPartner(Integer code, String shifr) {
        this.code = code;
        this.shifr = shifr;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SprPartner)) {
            return false;
        }
        SprPartner other = (SprPartner) object;
    ...
    public String toString() {
        return "org.tyaa.teplosetejb.entity.SprPartner[ code=" + code + " ]";
    }
