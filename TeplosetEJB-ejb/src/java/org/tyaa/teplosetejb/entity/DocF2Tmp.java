 ...
 */
@Entity
@Table(name = "DOC_F2_TMP")
@NamedQueries({
    @NamedQuery(name = "DocF2Tmp.findAll", query = "SELECT d FROM DocF2Tmp d")})
public class DocF2Tmp implements Serializable {
    ...
    public DocF2Tmp(Integer code) {
        this.code = code;
    }

    public DocF2Tmp(Integer code, int doc, int state) {
        this.code = code;
        this.doc = doc;
        this.state = state;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof DocF2Tmp)) {
            return false;
        }
        DocF2Tmp other = (DocF2Tmp) object;
    ...
    public String toString() {
        return "org.tyaa.teplosetejb.entity.DocF2Tmp[ code=" + code + " ]";
    }
