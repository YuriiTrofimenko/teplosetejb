 ...
 */
@Entity
@Table(name = "MOV_F2_ZOVT")
@NamedQueries({
    @NamedQuery(name = "MovF2Zovt.findAll", query = "SELECT m FROM MovF2Zovt m")})
public class MovF2Zovt implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof MovF2Zovt)) {
            return false;
        }
        MovF2Zovt other = (MovF2Zovt) object;
    ...
    public String toString() {
        return "org.tyaa.teplosetejb.entity.MovF2Zovt[ id=" + id + " ]";
    }
