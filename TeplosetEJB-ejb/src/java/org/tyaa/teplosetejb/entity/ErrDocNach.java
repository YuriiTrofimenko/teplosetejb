 ...
 */
@Entity
@Table(name = "ERR_DOC_NACH")
@NamedQueries({
    @NamedQuery(name = "ErrDocNach.findAll", query = "SELECT e FROM ErrDocNach e")})
public class ErrDocNach implements Serializable {
    ...
    public ErrDocNach(Integer code) {
        this.code = code;
    }

    public ErrDocNach(Integer code, int doc) {
        this.code = code;
        this.doc = doc;
    }
    ...
    public DocNach getPos() {
        return pos;
    }

    public void setPos(DocNach pos) {
        this.pos = pos;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ErrDocNach)) {
            return false;
        }
        ErrDocNach other = (ErrDocNach) object;
    ...
    public String toString() {
        return "org.tyaa.teplosetejb.entity.ErrDocNach[ code=" + code + " ]";
    }
