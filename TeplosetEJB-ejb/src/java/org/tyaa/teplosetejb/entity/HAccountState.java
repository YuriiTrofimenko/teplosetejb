 ...
 */
@Entity
@Table(name = "H_ACCOUNT_STATE")
@NamedQueries({
    @NamedQuery(name = "HAccountState.findAll", query = "SELECT h FROM HAccountState h")})
public class HAccountState implements Serializable {
    ...
    public HAccountState() {
    }

    public HAccountState(Integer code) {
        this.code = code;
    }

    public HAccountState(Integer code, int accountStatecode, long accountcode, Date begindate) {
        this.code = code;
    ...
    public void setAccountStatecode(int accountStatecode) {
        this.accountStatecode = accountStatecode;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof HAccountState)) {
            return false;
        }
        HAccountState other = (HAccountState) object;
    ...
    public String toString() {
        return "org.tyaa.teplosetejb.entity.HAccountState[ code=" + code + " ]";
    }
