 ...
 */
@Entity
@Table(name = "H_SPR_ZHEK")
@NamedQueries({
    @NamedQuery(name = "HSprZhek.findAll", query = "SELECT h FROM HSprZhek h")})
public class HSprZhek implements Serializable {
    ...
    public HSprZhek(Integer code) {
        this.code = code;
    }

    public HSprZhek(Integer code, int zhekcode, String shifr, int groupzhekcode, String name) {
        this.code = code;
    ...
    public int getZhekcode() {
        return zhekcode;
    }

    public void setZhekcode(int zhekcode) {
        this.zhekcode = zhekcode;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof HSprZhek)) {
            return false;
        }
        HSprZhek other = (HSprZhek) object;
    ...
    public String toString() {
        return "org.tyaa.teplosetejb.entity.HSprZhek[ code=" + code + " ]";
    }
