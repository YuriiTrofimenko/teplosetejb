 ...
 */
@Entity
@Table(name = "SPR_EXAMPL_1")
@NamedQueries({
    @NamedQuery(name = "SprExampl1.findAll", query = "SELECT s FROM SprExampl1 s")})
public class SprExampl1 implements Serializable {
    ...
    public SprExampl1(Integer code) {
        this.code = code;
    }

    public SprExampl1(Integer code, String shifr, String name, int finsource) {
        this.code = code;
        this.shifr = shifr;
        this.name = name;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SprExampl1)) {
            return false;
        }
        SprExampl1 other = (SprExampl1) object;
    ...
    public String toString() {
        return "org.tyaa.teplosetejb.entity.SprExampl1[ code=" + code + " ]";
    }
