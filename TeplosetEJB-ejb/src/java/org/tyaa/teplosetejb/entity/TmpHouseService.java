 ...
 */
@Entity
@Table(name = "TMP_HOUSE_SERVICE")
@NamedQueries({
    @NamedQuery(name = "TmpHouseService.findAll", query = "SELECT t FROM TmpHouseService t")})
public class TmpHouseService implements Serializable {
    ...
    public TmpHouseService() {
    }

    public TmpHouseService(Integer code) {
        this.code = code;
    }

    public TmpHouseService(Integer code, int housecode, int housePipecode, Date begindate) {
        this.code = code;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TmpHouseService)) {
            return false;
        }
        TmpHouseService other = (TmpHouseService) object;
    ...
    public String toString() {
        return "org.tyaa.teplosetejb.entity.TmpHouseService[ code=" + code + " ]";
    }
