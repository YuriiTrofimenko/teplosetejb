...
public class AccountService implements Serializable {
    ...
    public AccountService(Integer code) {
        this.code = code;
    }

    public AccountService(Integer code, long accountcode, int service, int accountPipecode, Date begindate) {
        this.code = code;
    ...
    public String toString() {
        return "org.tyaa.teplosetejb.entity.AccountService[ code=" + code + " ]";
    }
