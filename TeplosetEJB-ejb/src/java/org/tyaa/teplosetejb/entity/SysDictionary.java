...
public class SysDictionary implements Serializable {
    ...
    public SysDictionary(Integer code) {
        this.code = code;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SysDictionary)) {
            return false;
        }
        SysDictionary other = (SysDictionary) object;
    ...
    public String toString() {
        return "org.tyaa.teplosetejb.entity.SysDictionary[ code=" + code + " ]";
    }
