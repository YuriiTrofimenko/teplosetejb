 ...
 */
@Entity
@Table(name = "DOC_EXAMPL_ADDWORKER")
@NamedQueries({
    @NamedQuery(name = "DocExamplAddworker.findAll", query = "SELECT d FROM DocExamplAddworker d")})
public class DocExamplAddworker implements Serializable {
    ...
    public DocExamplAddworker() {
    }

    public DocExamplAddworker(Integer code) {
        this.code = code;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof DocExamplAddworker)) {
            return false;
        }
        DocExamplAddworker other = (DocExamplAddworker) object;
    ...
    public String toString() {
        return "org.tyaa.teplosetejb.entity.DocExamplAddworker[ code=" + code + " ]";
    }
