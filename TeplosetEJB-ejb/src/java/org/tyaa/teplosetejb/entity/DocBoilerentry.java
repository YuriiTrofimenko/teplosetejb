 ...
 */
@Entity
@Table(name = "DOC_BOILERENTRY")
@NamedQueries({
    @NamedQuery(name = "DocBoilerentry.findAll", query = "SELECT d FROM DocBoilerentry d")})
public class DocBoilerentry implements Serializable {
    ...
    public DocBoilerentry() {
    }

    public DocBoilerentry(Integer code) {
        this.code = code;
    }

    public DocBoilerentry(Integer code, int state) {
        this.code = code;
        this.state = state;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof DocBoilerentry)) {
            return false;
        }
        DocBoilerentry other = (DocBoilerentry) object;
    ...
    public String toString() {
        return "org.tyaa.teplosetejb.entity.DocBoilerentry[ code=" + code + " ]";
    }
