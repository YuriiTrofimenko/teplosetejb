...
public class SprReason implements Serializable {
    ...
    public SprReason(Integer code) {
        this.code = code;
    }

    public SprReason(Integer code, int owner, int iselement, String shifr, String name) {
        this.code = code;
        this.owner = owner;
    ...
    public String toString() {
        return "org.tyaa.teplosetejb.entity.SprReason[ code=" + code + " ]";
    }
