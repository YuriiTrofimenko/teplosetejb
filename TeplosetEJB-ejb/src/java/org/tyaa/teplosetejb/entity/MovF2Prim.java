 ...
 */
@Entity
@Table(name = "MOV_F2_PRIM")
@NamedQueries({
    @NamedQuery(name = "MovF2Prim.findAll", query = "SELECT m FROM MovF2Prim m")})
public class MovF2Prim implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof MovF2Prim)) {
            return false;
        }
        MovF2Prim other = (MovF2Prim) object;
    ...
    public String toString() {
        return "org.tyaa.teplosetejb.entity.MovF2Prim[ id=" + id + " ]";
    }
