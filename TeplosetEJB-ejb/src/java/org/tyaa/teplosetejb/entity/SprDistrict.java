 ...
 */
@Entity
@Table(name = "SPR_DISTRICT")
@NamedQueries({
    @NamedQuery(name = "SprDistrict.findAll", query = "SELECT s FROM SprDistrict s")})
public class SprDistrict implements Serializable {
    ...
    public SprDistrict(Integer code) {
        this.code = code;
    }

    public SprDistrict(Integer code, String shifr, int town, String name) {
        this.code = code;
        this.shifr = shifr;
        this.town = town;
        this.name = name;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SprDistrict)) {
            return false;
        }
        SprDistrict other = (SprDistrict) object;
    ...
    public String toString() {
        return "org.tyaa.teplosetejb.entity.SprDistrict[ code=" + code + " ]";
    }
