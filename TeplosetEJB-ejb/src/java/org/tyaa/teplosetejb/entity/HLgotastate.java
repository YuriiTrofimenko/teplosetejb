 ...
 */
@Entity
@Table(name = "H_LGOTASTATE")
@NamedQueries({
    @NamedQuery(name = "HLgotastate.findAll", query = "SELECT h FROM HLgotastate h")})
public class HLgotastate implements Serializable {
    ...
    public HLgotastate(Integer code) {
        this.code = code;
    }

    public HLgotastate(Integer code, int lgotastatecode, long accountcode, int number, Date begindate, int lgotacode) {
        this.code = code;
    ...
    public int getLgotastatecode() {
        return lgotastatecode;
    }

    public void setLgotastatecode(int lgotastatecode) {
        this.lgotastatecode = lgotastatecode;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof HLgotastate)) {
            return false;
        }
        HLgotastate other = (HLgotastate) object;
    ...
    public String toString() {
        return "org.tyaa.teplosetejb.entity.HLgotastate[ code=" + code + " ]";
    }
