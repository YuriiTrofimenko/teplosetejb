...
@Entity
@NamedQueries({
    @NamedQuery(name = "Calcresult.findAll", query = "SELECT c FROM Calcresult c")})
public class Calcresult implements Serializable {
    ...
    @Column(name = "CALC_OWNER_PIPECODE")
    private Integer calcOwnerPipecode;
    @Column(name = "ALLOW_NORM")
    private Integer allowNorm;
    @Column(name = "SOCIAL_NORM_CODE")
    private Integer socialNormCode;
    @Column(name = "DISCOUNT_S2")
    private BigDecimal discountS2;
    @Column(name = "NACH_KOEFF")
    private Double nachKoeff;
    @Column(name = "FN_CALC")
    private Integer fnCalc;

    public Calcresult() {
    }

    public Calcresult(Integer code) {
        this.code = code;
    }

    public Calcresult(Integer code, int firmcode, int saldokind, int procdate, int todate, long accountcode, int housecode, int ps, int pskind) {
        this.code = code;
    ...
    public Integer getCalcOwnerPipecode() {
        return calcOwnerPipecode;
    }

    public void setCalcOwnerPipecode(Integer calcOwnerPipecode) {
        this.calcOwnerPipecode = calcOwnerPipecode;
    }
    ...
    public Integer getSocialNormCode() {
        return socialNormCode;
    }

    public void setSocialNormCode(Integer socialNormCode) {
    ...
    public Integer getFnCalc() {
        return fnCalc;
    }

    public void setFnCalc(Integer fnCalc) {
        this.fnCalc = fnCalc;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Calcresult)) {
            return false;
        }
        Calcresult other = (Calcresult) object;
    ...
    public String toString() {
        return "org.tyaa.teplosetejb.entity.Calcresult[ code=" + code + " ]";
    }
