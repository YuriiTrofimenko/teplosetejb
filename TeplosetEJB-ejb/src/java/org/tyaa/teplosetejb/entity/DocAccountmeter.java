 ...
 */
@Entity
@Table(name = "DOC_ACCOUNTMETER")
@NamedQueries({
    @NamedQuery(name = "DocAccountmeter.findAll", query = "SELECT d FROM DocAccountmeter d")})
public class DocAccountmeter implements Serializable {
    ...
    public DocAccountmeter() {
    }

    public DocAccountmeter(Integer code) {
        this.code = code;
    }

    public DocAccountmeter(Integer code, int posadd, int state) {
        this.code = code;
        this.posadd = posadd;
        this.state = state;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof DocAccountmeter)) {
            return false;
        }
        DocAccountmeter other = (DocAccountmeter) object;
    ...
    public String toString() {
        return "org.tyaa.teplosetejb.entity.DocAccountmeter[ code=" + code + " ]";
    }
