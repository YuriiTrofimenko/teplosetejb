...
@Table(name = "MOV_F2")
@NamedQueries({
    @NamedQuery(name = "MovF2.findAll", query = "SELECT m FROM MovF2 m")})
public class MovF2 implements Serializable {
    ...
    @Column(name = "SOURCE_MONTH_FOR_UPDATE")
    private Integer sourceMonthForUpdate;

    public MovF2() {
    }

    public MovF2(Integer id) {
        this.id = id;
    }
    ...
    public Integer getSourceMonthForUpdate() {
        return sourceMonthForUpdate;
    }

    public void setSourceMonthForUpdate(Integer sourceMonthForUpdate) {
        this.sourceMonthForUpdate = sourceMonthForUpdate;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof MovF2)) {
            return false;
        }
        MovF2 other = (MovF2) object;
    ...
    public String toString() {
        return "org.tyaa.teplosetejb.entity.MovF2[ id=" + id + " ]";
    }
