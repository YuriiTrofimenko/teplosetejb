 ...
 */
@Entity
@Table(name = "H_SPR_NORM")
@NamedQueries({
    @NamedQuery(name = "HSprNorm.findAll", query = "SELECT h FROM HSprNorm h")})
public class HSprNorm implements Serializable {
    ...
    public HSprNorm(Integer code) {
        this.code = code;
    }

    public HSprNorm(Integer code, int normcode, String shifr, String name) {
        this.code = code;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof HSprNorm)) {
            return false;
        }
        HSprNorm other = (HSprNorm) object;
    ...
    public String toString() {
        return "org.tyaa.teplosetejb.entity.HSprNorm[ code=" + code + " ]";
    }
