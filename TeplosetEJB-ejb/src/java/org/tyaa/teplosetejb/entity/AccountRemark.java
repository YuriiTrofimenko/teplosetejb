 ...
 */
@Entity
@Table(name = "ACCOUNT_REMARK")
@NamedQueries({
    @NamedQuery(name = "AccountRemark.findAll", query = "SELECT a FROM AccountRemark a")})
public class AccountRemark implements Serializable {
    ...
    public AccountRemark(Integer code) {
        this.code = code;
    }

    public AccountRemark(Integer code, long accountcode, int procdate) {
        this.code = code;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof AccountRemark)) {
            return false;
        }
        AccountRemark other = (AccountRemark) object;
    ...
    public String toString() {
        return "org.tyaa.teplosetejb.entity.AccountRemark[ code=" + code + " ]";
    }
