 ...
 */
@Entity
@Table(name = "SPR_BOILERHOUSE")
@NamedQueries({
    @NamedQuery(name = "SprBoilerhouse.findAll", query = "SELECT s FROM SprBoilerhouse s")})
public class SprBoilerhouse implements Serializable {
