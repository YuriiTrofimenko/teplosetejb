...
@Table(name = "SPR_ZHSK")
@NamedQueries({
    @NamedQuery(name = "SprZhsk.findAll", query = "SELECT s FROM SprZhsk s")})
public class SprZhsk implements Serializable {
    ...
    public SprZhsk(Integer code) {
        this.code = code;
    }

    public SprZhsk(Integer code, String shifr, String name) {
        this.code = code;
        this.shifr = shifr;
        this.name = name;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SprZhsk)) {
            return false;
        }
        SprZhsk other = (SprZhsk) object;
    ...
    public String toString() {
        return "org.tyaa.teplosetejb.entity.SprZhsk[ code=" + code + " ]";
    }
