 ...
 */
@Entity
@Table(name = "ERR_DOC_SALDO")
@NamedQueries({
    @NamedQuery(name = "ErrDocSaldo.findAll", query = "SELECT e FROM ErrDocSaldo e")})
public class ErrDocSaldo implements Serializable {
    ...
    public ErrDocSaldo(Integer code) {
        this.code = code;
    }

    public ErrDocSaldo(Integer code, int doc) {
        this.code = code;
        this.doc = doc;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ErrDocSaldo)) {
            return false;
        }
        ErrDocSaldo other = (ErrDocSaldo) object;
    ...
    public String toString() {
        return "org.tyaa.teplosetejb.entity.ErrDocSaldo[ code=" + code + " ]";
    }
