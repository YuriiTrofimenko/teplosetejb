 ...
 */
@Entity
@Table(name = "DOC_HOUSEMETER")
@NamedQueries({
    @NamedQuery(name = "DocHousemeter.findAll", query = "SELECT d FROM DocHousemeter d")})
public class DocHousemeter implements Serializable {
    ...
    public DocHousemeter() {
    }

    public DocHousemeter(Integer code) {
        this.code = code;
    }

    public DocHousemeter(Integer code, int posadd, int state) {
        this.code = code;
        this.posadd = posadd;
        this.state = state;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof DocHousemeter)) {
            return false;
        }
        DocHousemeter other = (DocHousemeter) object;
    ...
    public String toString() {
        return "org.tyaa.teplosetejb.entity.DocHousemeter[ code=" + code + " ]";
    }
