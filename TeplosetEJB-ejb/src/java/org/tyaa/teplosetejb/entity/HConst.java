...
@Table(name = "H_CONST")
@NamedQueries({
    @NamedQuery(name = "HConst.findAll", query = "SELECT h FROM HConst h")})
public class HConst implements Serializable {
    ...
    public HConst(Integer code) {
        this.code = code;
    }

    public HConst(Integer code, int constCode) {
        this.code = code;
    ...
    public void setConstCode(int constCode) {
        this.constCode = constCode;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof HConst)) {
            return false;
        }
        HConst other = (HConst) object;
    ...
    public String toString() {
        return "org.tyaa.teplosetejb.entity.HConst[ code=" + code + " ]";
    }
