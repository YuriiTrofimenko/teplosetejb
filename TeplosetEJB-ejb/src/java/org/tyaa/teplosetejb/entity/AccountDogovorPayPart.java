 ...
 */
@Entity
@Table(name = "ACCOUNT_DOGOVOR_PAY_PART")
@NamedQueries({
    @NamedQuery(name = "AccountDogovorPayPart.findAll", query = "SELECT a FROM AccountDogovorPayPart a")})
public class AccountDogovorPayPart implements Serializable {
    ...
    public AccountDogovorPayPart() {
    }

    public AccountDogovorPayPart(Integer code) {
        this.code = code;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof AccountDogovorPayPart)) {
            return false;
        }
        AccountDogovorPayPart other = (AccountDogovorPayPart) object;
    ...
    public String toString() {
        return "org.tyaa.teplosetejb.entity.AccountDogovorPayPart[ code=" + code + " ]";
    }
