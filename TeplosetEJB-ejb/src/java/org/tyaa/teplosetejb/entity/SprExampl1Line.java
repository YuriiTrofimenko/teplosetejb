 ...
 */
@Entity
@Table(name = "SPR_EXAMPL_1_LINE")
@NamedQueries({
    @NamedQuery(name = "SprExampl1Line.findAll", query = "SELECT s FROM SprExampl1Line s")})
public class SprExampl1Line implements Serializable {
    ...
    public SprExampl1Line() {
    }

    public SprExampl1Line(Integer code) {
        this.code = code;
    }

    public SprExampl1Line(Integer code, Date begindate, BigDecimal percent) {
        this.code = code;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SprExampl1Line)) {
            return false;
        }
        SprExampl1Line other = (SprExampl1Line) object;
    ...
    public String toString() {
        return "org.tyaa.teplosetejb.entity.SprExampl1Line[ code=" + code + " ]";
    }
