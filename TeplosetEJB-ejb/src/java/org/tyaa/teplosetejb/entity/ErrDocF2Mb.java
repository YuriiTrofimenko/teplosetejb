 ...
 */
@Entity
@Table(name = "ERR_DOC_F2_MB")
@NamedQueries({
    @NamedQuery(name = "ErrDocF2Mb.findAll", query = "SELECT e FROM ErrDocF2Mb e")})
public class ErrDocF2Mb implements Serializable {
    ...
    public ErrDocF2Mb(Integer code) {
        this.code = code;
    }
    ...
    public DocF2Mb getPos() {
        return pos;
    }

    public void setPos(DocF2Mb pos) {
        this.pos = pos;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ErrDocF2Mb)) {
            return false;
        }
        ErrDocF2Mb other = (ErrDocF2Mb) object;
    ...
    public String toString() {
        return "org.tyaa.teplosetejb.entity.ErrDocF2Mb[ code=" + code + " ]";
    }
