 ...
 */
@Entity
@Table(name = "ERR_DOC_CHANGE_METER")
@NamedQueries({
    @NamedQuery(name = "ErrDocChangeMeter.findAll", query = "SELECT e FROM ErrDocChangeMeter e")})
public class ErrDocChangeMeter implements Serializable {
    ...
    public ErrDocChangeMeter() {
    }

    public ErrDocChangeMeter(Integer code) {
        this.code = code;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ErrDocChangeMeter)) {
            return false;
        }
        ErrDocChangeMeter other = (ErrDocChangeMeter) object;
    ...
    public String toString() {
        return "org.tyaa.teplosetejb.entity.ErrDocChangeMeter[ code=" + code + " ]";
    }
