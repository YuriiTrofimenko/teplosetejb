 ...
 */
@Entity
@Table(name = "MOV_F2_IL")
@NamedQueries({
    @NamedQuery(name = "MovF2Il.findAll", query = "SELECT m FROM MovF2Il m")})
public class MovF2Il implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof MovF2Il)) {
            return false;
        }
        MovF2Il other = (MovF2Il) object;
    ...
    public String toString() {
        return "org.tyaa.teplosetejb.entity.MovF2Il[ id=" + id + " ]";
    }
