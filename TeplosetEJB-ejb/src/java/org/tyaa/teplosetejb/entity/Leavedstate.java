...
@Entity
@NamedQueries({
    @NamedQuery(name = "Leavedstate.findAll", query = "SELECT l FROM Leavedstate l")})
public class Leavedstate implements Serializable {
    ...
    public Leavedstate(Integer code) {
        this.code = code;
    }

    public Leavedstate(Integer code, long accountcode, Date begindate) {
        this.code = code;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Leavedstate)) {
            return false;
        }
        Leavedstate other = (Leavedstate) object;
    ...
    public String toString() {
        return "org.tyaa.teplosetejb.entity.Leavedstate[ code=" + code + " ]";
    }
