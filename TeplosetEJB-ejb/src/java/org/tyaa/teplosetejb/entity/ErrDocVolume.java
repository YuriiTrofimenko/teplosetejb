 ...
 */
@Entity
@Table(name = "ERR_DOC_VOLUME")
@NamedQueries({
    @NamedQuery(name = "ErrDocVolume.findAll", query = "SELECT e FROM ErrDocVolume e")})
public class ErrDocVolume implements Serializable {
    ...
    @ManyToOne
    private DocVolume pos;

    public ErrDocVolume() {
    }

    public ErrDocVolume(Integer code) {
        this.code = code;
    }
    ...
    public DocVolume getPos() {
        return pos;
    }

    public void setPos(DocVolume pos) {
        this.pos = pos;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ErrDocVolume)) {
            return false;
        }
        ErrDocVolume other = (ErrDocVolume) object;
    ...
    public String toString() {
        return "org.tyaa.teplosetejb.entity.ErrDocVolume[ code=" + code + " ]";
    }
