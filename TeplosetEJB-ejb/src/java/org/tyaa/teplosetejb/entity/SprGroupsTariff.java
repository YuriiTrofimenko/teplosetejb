 ...
 */
@Entity
@Table(name = "SPR_GROUPS_TARIFF")
@NamedQueries({
    @NamedQuery(name = "SprGroupsTariff.findAll", query = "SELECT s FROM SprGroupsTariff s")})
public class SprGroupsTariff implements Serializable {
