 ...
 */
@Entity
@Table(name = "ERR_DOC_USZN")
@NamedQueries({
    @NamedQuery(name = "ErrDocUszn.findAll", query = "SELECT e FROM ErrDocUszn e")})
public class ErrDocUszn implements Serializable {
    ...
    public ErrDocUszn(Integer code) {
        this.code = code;
    }
    ...
    public DocUszn getPos() {
        return pos;
    }

    public void setPos(DocUszn pos) {
        this.pos = pos;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ErrDocUszn)) {
            return false;
        }
        ErrDocUszn other = (ErrDocUszn) object;
    ...
    public String toString() {
        return "org.tyaa.teplosetejb.entity.ErrDocUszn[ code=" + code + " ]";
    }
