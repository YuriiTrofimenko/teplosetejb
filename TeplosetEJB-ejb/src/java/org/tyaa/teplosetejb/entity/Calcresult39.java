...
@Entity
@NamedQueries({
    @NamedQuery(name = "Calcresult39.findAll", query = "SELECT c FROM Calcresult39 c")})
public class Calcresult39 implements Serializable {
    ...
    public Calcresult39(Integer code) {
        this.code = code;
    }

    public Calcresult39(Integer code, int firmcode, int saldokind, int procdate, int todate, long accountcode, int housecode, int ps, int pskind) {
        this.code = code;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Calcresult39)) {
            return false;
        }
        Calcresult39 other = (Calcresult39) object;
    ...
    public String toString() {
        return "org.tyaa.teplosetejb.entity.Calcresult39[ code=" + code + " ]";
    }
