 ...
 */
@Entity
@Table(name = "MOV_PR_ISP")
@NamedQueries({
    @NamedQuery(name = "MovPrIsp.findAll", query = "SELECT m FROM MovPrIsp m")})
public class MovPrIsp implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof MovPrIsp)) {
            return false;
        }
        MovPrIsp other = (MovPrIsp) object;
    ...
    public String toString() {
        return "org.tyaa.teplosetejb.entity.MovPrIsp[ id=" + id + " ]";
    }
