 ...
 */
@Entity
@Table(name = "H_SPR_AREA")
@NamedQueries({
    @NamedQuery(name = "HSprArea.findAll", query = "SELECT h FROM HSprArea h")})
public class HSprArea implements Serializable {
    ...
    public HSprArea(Integer code) {
        this.code = code;
    }

    public HSprArea(Integer code, int areacode, String shifr, String name, int district) {
        this.code = code;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof HSprArea)) {
            return false;
        }
        HSprArea other = (HSprArea) object;
    ...
    public String toString() {
        return "org.tyaa.teplosetejb.entity.HSprArea[ code=" + code + " ]";
    }
