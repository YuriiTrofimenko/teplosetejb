 ...
 */
@Entity
@Table(name = "METER_ACT")
@NamedQueries({
    @NamedQuery(name = "MeterAct.findAll", query = "SELECT m FROM MeterAct m")})
public class MeterAct implements Serializable {
    ...
    public MeterAct(Integer code) {
        this.code = code;
    }

    public MeterAct(Integer code, String actNumber) {
        this.code = code;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof MeterAct)) {
            return false;
        }
        MeterAct other = (MeterAct) object;
    ...
    public String toString() {
        return "org.tyaa.teplosetejb.entity.MeterAct[ code=" + code + " ]";
    }
