...
@NamedQueries({
    @NamedQuery(name = "AccountClaim.findAll", query = "SELECT a FROM AccountClaim a")})
public class AccountClaim implements Serializable {
    ...
    public AccountClaim(Integer code) {
        this.code = code;
    }

    public AccountClaim(Integer code, long accountcode, int procdate) {
        this.code = code;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof AccountClaim)) {
            return false;
        }
        AccountClaim other = (AccountClaim) object;
    ...
    public String toString() {
        return "org.tyaa.teplosetejb.entity.AccountClaim[ code=" + code + " ]";
    }
