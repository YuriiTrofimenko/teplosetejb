 ...
 */
@Entity
@Table(name = "SPR_METERTYPE")
@NamedQueries({
    @NamedQuery(name = "SprMetertype.findAll", query = "SELECT s FROM SprMetertype s")})
public class SprMetertype implements Serializable {
    ...
    public SprMetertype(Integer code) {
        this.code = code;
    }

    public SprMetertype(Integer code, String shifr, String name) {
        this.code = code;
        this.shifr = shifr;
        this.name = name;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SprMetertype)) {
            return false;
        }
        SprMetertype other = (SprMetertype) object;
    ...
    public String toString() {
        return "org.tyaa.teplosetejb.entity.SprMetertype[ code=" + code + " ]";
    }
