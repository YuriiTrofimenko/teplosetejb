 ...
 */
@Entity
@Table(name = "MOV_ZH_ISP")
@NamedQueries({
    @NamedQuery(name = "MovZhIsp.findAll", query = "SELECT m FROM MovZhIsp m")})
public class MovZhIsp implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof MovZhIsp)) {
            return false;
        }
        MovZhIsp other = (MovZhIsp) object;
    ...
    public String toString() {
        return "org.tyaa.teplosetejb.entity.MovZhIsp[ id=" + id + " ]";
    }
