 ...
 */
@Entity
@Table(name = "H_HOUSE_ARENDA")
@NamedQueries({
    @NamedQuery(name = "HHouseArenda.findAll", query = "SELECT h FROM HHouseArenda h")})
public class HHouseArenda implements Serializable {
    ...
    @Basic(optional = false)
    @NotNull
    @Column(name = "HOUSE_ARENDA_CODE")
    private int houseArendaCode;
    @Basic(optional = false)
    @NotNull
    ...
    public HHouseArenda(Integer code) {
        this.code = code;
    }

    public HHouseArenda(Integer code, int houseArendaCode, int housecode, int housePipecode, Date begindate) {
        this.code = code;
        this.houseArendaCode = houseArendaCode;
    ...
    public int getHouseArendaCode() {
        return houseArendaCode;
    }

    public void setHouseArendaCode(int houseArendaCode) {
        this.houseArendaCode = houseArendaCode;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof HHouseArenda)) {
            return false;
        }
        HHouseArenda other = (HHouseArenda) object;
    ...
    public String toString() {
        return "org.tyaa.teplosetejb.entity.HHouseArenda[ code=" + code + " ]";
    }
