 ...
 */
@Entity
@Table(name = "PIPE_WORK_TIME")
@NamedQueries({
    @NamedQuery(name = "PipeWorkTime.findAll", query = "SELECT p FROM PipeWorkTime p")})
public class PipeWorkTime implements Serializable {
    ...
    public PipeWorkTime(Integer code) {
        this.code = code;
    }

    public PipeWorkTime(Integer code, int pipecode) {
        this.code = code;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PipeWorkTime)) {
            return false;
        }
        PipeWorkTime other = (PipeWorkTime) object;
    ...
    public String toString() {
        return "org.tyaa.teplosetejb.entity.PipeWorkTime[ code=" + code + " ]";
    }
