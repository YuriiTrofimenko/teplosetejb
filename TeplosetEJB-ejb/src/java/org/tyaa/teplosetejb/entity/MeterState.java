...
@NamedQueries({
    @NamedQuery(name = "MeterState.findAll", query = "SELECT m FROM MeterState m")})
public class MeterState implements Serializable {
    ...
    public MeterState(Integer code) {
        this.code = code;
    }

    public MeterState(Integer code, int metercode, int pipecode, String number, Date begindate) {
        this.code = code;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof MeterState)) {
            return false;
        }
        MeterState other = (MeterState) object;
    ...
    public String toString() {
        return "org.tyaa.teplosetejb.entity.MeterState[ code=" + code + " ]";
    }
